...
\renewcommand{\tablename}{Tabla}
    \title{\textbf{Desarrollo de una aplicación de analítica del
    		aprendizaje basada en posturas corporales
    		utilizando Microsoft Kinect}}
    \author{\textbf{Rodolfo Alejandro Guíñez Espinoza}}
\principaladviser{Roberto Muñoz S.}
...
\bibliography{capitulo1}
%\bibliography{capitulo2}
\end{document}
